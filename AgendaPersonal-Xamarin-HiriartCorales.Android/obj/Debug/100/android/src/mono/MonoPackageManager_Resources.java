...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AgendaPersonal-Xamarin-HiriartCorales.Android.dll" comes first in this list. */
		"AgendaPersonal-Xamarin-HiriartCorales.Android.dll",
		"AgendaPersonal-Xamarin-HiriartCorales.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
